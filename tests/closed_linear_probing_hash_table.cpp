...
int run_test_02(unsigned test_num, uint64_t random_number, bool debug=false) {
...
int run_test_04(unsigned test_num, uint64_t random_number, bool debug=false) {
...
int run_test_06(unsigned test_num, uint64_t random_number, bool debug=false) {
...
int run_test(unsigned test_num, uint64_t random_number, bool debug = false) {
    ...
    switch (variant) {
    case  0: return run_test_00(test_num, random_number, debug);
    case  1: return run_test_02(test_num, random_number, debug);
    case  2: return run_test_04(test_num, random_number, debug);
    case  3: return run_test_06(test_num, random_number, debug);
    default: assert(0);
    }
